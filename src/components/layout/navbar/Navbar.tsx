...
const Navbar = () => {
  return (
    <nav className='text-md grid grid-cols-2 grid-rows-2 border-b-[1px] border-gray-300 bg-mercadolibre-primary px-10 py-2 lg:grid-cols-4 lg:grid-rows-1 lg:text-lg'>
      {/* score */}
      ...
      >
        <Image
          ...
          width='48' height='48'
          className='-mb-2 w-12 object-contain'
        />
